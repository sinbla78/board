package com.example.cmd.domain.user.service;

import com.example.cmd.domain.auth.RefreshTokenRepository;
...
import com.example.cmd.domain.user.service.exception.PasswordMismatchException;
import com.example.cmd.domain.user.service.exception.UserAlreadyExistException;
import com.example.cmd.domain.user.service.exception.UserNotFoundException;
import com.example.cmd.domain.user.service.facade.UserFacade;
    ...
    public void signUp(SignupRequest signupRequest) {
        ...
        userRepository.save(
                User.builder()
                        ...
                        .adress(signupRequest.getAdress())
                        .build()
        );
    }
